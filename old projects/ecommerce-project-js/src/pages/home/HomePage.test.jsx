...
describe('HomePage component', () => {
  ...
  it('displays the products correct', async () => {
    ...
    const quantitySelector1 = within(productContainer[0]).getByTestId('product-quantity-container');
    ...
    const quantitySelector2 = within(productContainer[1]).getByTestId('product-quantity-container');
